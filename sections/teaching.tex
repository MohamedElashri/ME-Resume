...
\innerlist{
	...
	\entryextra{Helping conduct problem solving sessions and Physics tutoring center}
		\entryextra{Grading assignments and tests, documenting results and informing lead teacher of students performance}
...
\entrybig
	...
	{Physics Teaching Assistant}{2018\textendash2020}
\innerlist{
	\entryextra{{Supported instructor with test administration, curriculum development, and assignment grading}
